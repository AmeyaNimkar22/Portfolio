...
const About = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center px-6 md:px-20 py-12 bg-white">
      <h2 className="text-4xl font-bold text-center mb-12 text-gray-700">About Me</h2>
      <div className="bg-purple-100 shadow-lg rounded-2xl p-8 md:p-12 text-gray-700 w-full max-w-4xl text-base leading-relaxed">
